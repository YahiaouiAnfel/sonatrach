...
$historique=$_POST['date'];
  $requete= $bdd->prepare("SELECT * FROM passation_des_marches WHERE historique LIKE ?  ORDER BY id DESC");
...
echo "<div class='ferme' align='center'>";
  ...
  $requete= $bdd->prepare("SELECT * FROM passation_des_marches ORDER BY id DESC");
