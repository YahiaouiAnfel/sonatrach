   ...
   <li><a class="drop" href="#">DPFP</a>
        <ul>
          <li><a href="suivi_contrat.php">Suivi des contrats</a></li>
           <li><a href="appelOffre.php">Appel d'offre</a></li>
      <li><a href="passation_des_marches.php">Passation des marches</a></li>
...
echo "<div  class='col-sm-12'>";
  ...
  echo '<p class="centre" style="color:black">Vous  voulez faire une recherche ? <a href="recherchesuivi_contrat.php?var=appel_offre">Rechercher</a></p>';
