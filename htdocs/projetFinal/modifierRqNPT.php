...
$r2=$_GET['historique'];
 ...
 if (isset($_POST['sub'])) {
            $ra=$_POST['rq'];
                                        ...
                                        $requete2= $bdd->prepare("UPDATE npt_dev SET remarque=? WHERE  Temps_Productif=? AND historique=? ");
...
$r2=$_GET['historique'];
 ...
 if (isset($_POST['sub'])) {
            $ra=$_POST['rq'];
                                        ...
                                        $requete2= $bdd->prepare("UPDATE npt_exp SET remarque=? WHERE  Temps_Productif=? AND historique=? ");
