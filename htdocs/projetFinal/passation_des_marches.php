...
<div class="wrapper bgded" style="background-color:#ffffff">
  <div id="pageintro" class="hoc clear"> 
   ...
   echo '<p class="centre"  style="color:black">Vous  voulez faire une recherche ? <a href="recherchepassation_des_marches.php">Rechercher</a></p></div>';
   $requete= $bdd->prepare("SELECT * FROM passation_des_marches WHERE date LIKE ? ORDER BY id DESC");
                          ...
                          $i=0;
                           ...
                           echo "<th class='table warning '>Contrat numéro</th>"; 
                            ...
                            echo "<th class='table warning'>Remarque</th>";  
                               ...
                               echo "<th class='table warning '>Fin depot d'offre</th>";   
...
if (($interval->format('%R%a ')>0)&&($interval->format('%R%a ')<60) ){
                      ...
                      echo "<td class='table warning'>".$row[$i]["intitule_description_des_marches"]."</td>";   
                         ...
                         if ($row[$i]["remarque"]!=="") {
                          ...
                          echo "<td class='table warning' ><a href='modifierRqpassation_des_marches.php?remarque=".$row[$i]["remarque"]."&numero_appel_offre=".$row[$i]["numero_appel_offre"]."&contrat_num=".$row[$i]["contrat_num"]."'>Editer</a></td>";
                             ...
                             echo "<td class='table warning'><a href='passation_des_marchescomplet.php?numero_appel_offre=".$row[$i]["numero_appel_offre"]."&contrat_num=".$row[$i]["contrat_num"]."'>details</a></td>";   
                             echo "<td class='table warning'>".$interval->format('%R%a ')."jours</td>";
                        echo "</tr>";
 ...
 elseif (($interval->format('%R%a ')>60)&&($interval->format('%R%a ')<365) ){
