...
$historique=$_POST['date'];
  $requete= $bdd->prepare("SELECT * FROM contrat WHERE historique LIKE ?  ORDER BY id DESC");
                      ...
                      echo "<form method='get'>";
                         ...
                         if ($row[$i]["remarque"]!=="") {
                           echo "<td class='table warning' ><a href='modifierRqsuivi_contrat.php?remarque=".$row[$i]["remarque"]."&Num_contrat=".$row[$i]["Num_contrat"]."&historique=".$row[$i]["historique"]."'>".$row[$i]["remarque"]."</a></td>";   
                          } 
                         else{
                         echo "<td class='table warning' ><a href='modifierRqsuivi_contrat.php?remarque=".$row[$i]["remarque"]."&Num_contrat=".$row[$i]["Num_contrat"]."&historique=".$row[$i]["historique"]."'>Editer</a></td>"; 
                         }
                             echo "<td class='table warning'><a href='suivi_contratcomplet.php?var1=".$row[$i]["Num_contrat"]."&historique=".$row[$i]["historique"]."'>details</a></td>";         
                          echo "</tr>";
                            $i++;}
                      echo "</form>";
