...
$r1=$_GET['numero_appel_offre'];
     ...
     echo "<th class='table warning '>Ouverture public offre</th>";    
                      ...
                      echo "<td class='table warning'>".$row[$i]["intitule_description_des_marches"]."</td>";   
                         ...
                         if ($row[$i]["remarque"]!=="") {
                           echo "<td class='table warning' ><a href='modifierRqpassation_des_marches1.php?remarque=".$row[$i]["remarque"]."&numero_appel_offre=".$row[$i]["numero_appel_offre"]."&contrat_num=".$row[$i]["contrat_num"]."'>".$row[$i]["remarque"]."</a></td>";   
                          } 
                         else{
                          echo "<td class='table warning' ><a href='modifierRqpassation_des_marches1.php?remarque=".$row[$i]["remarque"]."&numero_appel_offre=".$row[$i]["numero_appel_offre"]."&contrat_num=".$row[$i]["contrat_num"]."'>Editer</a></td>";
                         }
