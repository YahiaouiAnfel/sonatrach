...
<br>
   ...
   echo '<p class="centre"  style="color:black">Vous  voulez faire une recherche ? <a href="rechercherhformation1.php">Rechercher</a></p></div>';
                      ...
                      echo "<td class='table warning'>".$row[$i]["matricule"]."</td>";   
                         ...
                         if ($row[$i]["remarque"]!=="") {
                          ...
                          echo "<td class='table warning' ><a href='modifierRqrhformation1.php?remarque=".$row[$i]["remarque"]."&matricule=".$row[$i]["matricule"]."&code_formation=".$row[$i]["code_formation"]."'>Editer</a></td>";
                             ...
                             echo "<td class='table warning'><a href='rhformationcomplet1.php?matricule=".$row[$i]["matricule"]."&code_formation=".$row[$i]["code_formation"]."'>details</a></td>";   
                        echo "</tr>";
