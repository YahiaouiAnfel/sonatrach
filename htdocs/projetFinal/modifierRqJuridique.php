...
<?php   
$r=$_GET['remarque'];
$r1=$_GET['num_Contrat_Avenant_Commande'];
$r2=$_GET['numero_de_contrat_de_base'];
 echo '<form method="post">';
                        echo '<div class="col-sm-12" align="center">';
                        echo '   <input type="textarea" name="rq" value="'.$r.' " class="form-control1 form-control"  autocomplete="off" style="color:black">';
                       echo '   </div><br>';
                        echo '  <div class="col-sm-12" align="center">';
 ...
 if (isset($_POST['sub'])) {
      $ra=$_POST['rq'];
                                        ...
                                        $requete2= $bdd->prepare("UPDATE juridique SET remarque=? WHERE  numero_de_contrat_de_base=? AND num_Contrat_Avenant_Commande=? ");
