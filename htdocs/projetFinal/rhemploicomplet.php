                          ...
                          echo "<tr>";
                           ...
                           echo "<td class='table warning'>".$row[$j]["mode_recrutement"]."</td>";     
                            echo "<td class='table warning'>".$row[$j]["motif_recrutement"]."</td>";    
                             ...
                             if ($row[$j]["remarque"]!=="") {
                           echo "<td class='table warning' ><a href='modifierRqJuridique.php?remarque=".$row[$j]["remarque"]."&code_fct=".$row[$j]["code_fct"]."&code_act=".$row[$j]["code_act"]."'>".$row[$j]["remarque"]."</a></td>";   
                          } 
                         else{
                          echo "<td class='table warning' ><a href='modifierRqJuridique.php?remarque=".$row[$j]["remarque"]."&code_fct=".$row[$j]["code_fct"]."&code_act=".$row[$j]["code_act"]."'>Editer</a></td>";
                         }
                           echo "</tr>";
