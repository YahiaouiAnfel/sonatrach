...
<div class="wrapper bgded" style="background-color:#ffffff">
  ...
  <h2 align="center" style="color: black">Planification EXP Sud </h2><hr>
...
echo "<div  class='col-sm-12'>";
  ...
  echo '<p class="centre"style="color:black">Vous  voulez faire une recherche ? <a href="rechercheplf1.php?var=exp_sud">Rechercher</a></p>';
