...
<div class="wrapper row1" style=" background-color:#E6E6E6;color:#000000;">
  <header id="header" class="hoc clear"> 
    ...
    <div id="logo" class="fl_left"  >
      <h1 style="z-index:1000; font-size:50px; font-family:Georgia, 'Times New Roman', Times, serif;"><a href="index.php">Sonatrach</a></h1>
                          ...
                          echo "<tr>";
                           ...
                           echo "<td class='table warning'>".$row[$j]["visa_commission_numero_visa"]."</td>";     
                            ...
                            echo "<td class='table warning'>".$row[$j]["passe_ouverte_refus_visa_commission_numero_visa_refuse"]."</td>";  
                             if ($row[$j]["remarque"]!=="") {
                           echo "<td class='table warning' ><a href='modifierRqJuridique1.php?remarque=".$row[$j]["remarque"]."&num_Contrat_Avenant_Commande=".$row[$j]["num_Contrat_Avenant_Commande"]."&numero_de_contrat_de_base=".$row[$j]["numero_de_contrat_de_base"]."'>".$row[$j]["remarque"]."</a></td>";   
                          } 
                         else{
                          echo "<td class='table warning' ><a href='modifierRqJuridique1.php?remarque=".$row[$j]["remarque"]."&num_Contrat_Avenant_Commande=".$row[$j]["num_Contrat_Avenant_Commande"]."&numero_de_contrat_de_base=".$row[$j]["numero_de_contrat_de_base"]."'>Editer</a></td>";
                         }
                           echo "</tr>";
